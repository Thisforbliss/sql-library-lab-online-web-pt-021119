...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name AS authors_name, subgenres.name AS subgenres_name FROM series INNER JOIN authors ON series.author_id = author.id INNER JOIN subgenres ON series.subgenre_id = subgenre.id;"
end
